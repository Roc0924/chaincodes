...
//func generateState(key string) interface{} {
//
//	// get source state
//	soruceByte, errorSourceByte := stub.GetState(source)
//	if nil != errorSourceByte {
//		shim.Error("get source state error:" + errorSourceByte.Error())
//	}
//
//	result := generateState(source)
//	return nil
//}
